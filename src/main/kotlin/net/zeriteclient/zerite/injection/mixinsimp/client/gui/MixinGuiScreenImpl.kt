...
import net.zeriteclient.zerite.game.options.GuiOptions
...
object MixinGuiScreenImpl {
    ...
    fun drawWorldBackground(tint: Int, width: Int, height: Int) {
        ...
        if (Minecraft.getMinecraft().theWorld == null || tint == Int.MAX_VALUE) {
        ...
        if (GuiOptions.blueGradient || tint == Int.MAX_VALUE || Minecraft.getMinecraft().theWorld == null) {
